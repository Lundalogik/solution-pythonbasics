...
def default_config():
    ...
    `lime_config.config['plugins']['solution_pythonbasics']`
...
try:
    ...
    logger.info('solution_pythonbasics doesn\'t implement any custom '
                'endpoints')

try:
    from .event_handlers import register_event_handlers  # noqa
except ImportError:
    logger.info('solution_pythonbasics doesn\'t implement any event '
                'handlers')

try:
    from .limeobject_classes import register_limeobject_classes  # noqa
except ImportError:
    logger.info('solution_pythonbasics doesn\'t implement any '
                'limeobject classes')
...
try:
    ...
    logger.info('solution_pythonbasics doesn\'t contain any '
                'translations')

try:
    from .config import register_config  # noqa
except ImportError:
    logger.info('solution_pythonbasics doesn\'t contain any config')
